			...
			<div id="content-contact">
				<p id='txt-contact'>
					...
					<span>
						...
						31400 TOULOUSE
						<br/><br/><br/>
						<strong style='color:#000000;'>ATTENTION : Pour toute demande de devis, merci de nous indiquez la quantité désirée, ainsi que le nombre de couleurs du visuel (bichromie / trichromie / quadrichromie)</strong>
					</span>
				</p>
				<div id="formulaire">
					<form action='mail.php' method='POST'>
						<table>
							<tr><td><strong>Votre message a bien été envoyé</strong></td></tr>
							<tr><td>Nous vous ferons parvenir un devis dans les meilleurs délais.</td></tr>
							<tr><td><a href='index.php'>Retour à l'accueil</a></td></tr>
						</table>
					</form>	
				</div>
			</div>
